...
public class MysendMail {
	 ...
	 * Just do it as this
	 */
	public boolean sendMail(String[] args) {
		String mailbody = "http://www.laabc.com 用户邮件注册测试 <font color=red>欢迎光临</font> <a href=\"http://www.laabc.com\">啦ABC</a>";
		MysendMail themail = new MysendMail("smtp.qq.com");
		themail.setNeedAuth(true);
		if (themail.setSubject("订单") == false)
			return false;
		...
		if (themail.setBody(mailbody) == false)
			return false;
		// 收件人邮箱
		if (themail.setTo("409787881@qq.com") == false)
			return false;
		// 发件人邮箱
		if (themail.setFrom("526998462@qq.com") == false)
			return false;
		// 设置附件
		// if (themail.addFileAffix("#######") == false)
		// return; // 附件在本地机子上的绝对路径
		themail.setNamePass("526998462@qq.com", "kk409787881"); // 用户名与密码
